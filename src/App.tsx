      ...
      <div className="fixed inset-0 bg-gradient-to-r from-blue-900 to-indigo-900 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-5xl md:text-7xl font-bold text-white animate-fade-in-up">
            <span className="inline-block animate-slide-up opacity-0" style={{ animationDelay: '0.2s', animationFillMode: 'forwards' }}>Tax</span>
            <span className="inline-block animate-slide-up opacity-0 text-blue-300" style={{ animationDelay: '0.7s', animationFillMode: 'forwards' }}>Truth</span>
          </h1>
      ...
      <header className="bg-white shadow-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center">
            <span className="text-2xl font-bold text-blue-900">Tax<span className="text-blue-500">Truth</span></span>
          </div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-16 max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
              ...
              <h3 className="text-xl font-bold text-blue-900 mb-2">Calculate Tax Liability</h3>
              <p className="text-gray-600 mb-4">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-8 shadow-md">
              <div className="mb-6">
                <h3 className="text-xl font-bold text-blue-900 mb-2">
                  More than <span className="text-blue-600">60,000</span> tax experts use our platform
                </h3>
                <p className="text-gray-600 mb-6">
                  My executives could learn it so quickly and we implemented literally in a couple of days. I am impressed with time-saving features embedded in the software like automated reconciliation of 2A data with invoices.
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="font-bold text-blue-900">Mr. Anil Chakravorthy</p>
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-8 shadow-md">
              <div className="mb-6">
                <h3 className="text-xl font-bold text-blue-900 mb-2">
                  <span className="text-blue-600">600,000+</span> businesses trust our SMB offerings
                </h3>
                <p className="text-gray-600 mb-6">
                  Earlier I used to call multiple customers, track my bank account or check messages for payments. Now I can send UPI links to customers and customers can pay from home. Compliance is easy.
                </p>
                <div className="flex items-center">
                  <div className="w-12 h-12 rounded-full bg-gray-300 mr-4 overflow-hidden">
                    <img 
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Business Owner, Printing Goods</p>
                  </div>
                </div>
              </div>
              <a href="#" className="text-blue-600 font-medium hover:underline inline-flex items-center">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-blue-100 max-w-2xl mx-auto">
              Join thousands of businesses and tax professionals who trust TaxTruth for their tax compliance needs
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-bold mb-2">600,000+</div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Join thousands of businesses and tax professionals who trust TaxTruth
            </p>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-400 hover:text-white">MaxiTC</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white">Enterprise</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white">TaxCloud</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white">E-Invoicing</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white">GST Software</a></li>
              </ul>
            </div>
            <div>
